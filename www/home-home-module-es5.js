...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(storage, localNotifications) {
      ...
      _createClass(HomePage, [{
        ...
        key: "removeMed",
        value: function removeMed(index) {
          var _this2 = this;

          this.medList.splice(index, 1);
          this.storage.remove('MedList').then(function () {
            _this2.storage.set('MedList', _this2.medList);
          });
          this.localNotifications.clearAll().then(function () {
            var noticeList = [];
            var idIndex = 1;

            _this2.medList.forEach(function (notice) {
            ...
            _this2.localNotifications.schedule(noticeList);
          });
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"], _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_3__["LocalNotifications"]])], HomePage);
    /***/
  }
}]);
